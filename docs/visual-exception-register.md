...
| `urls-library-desktop.png`          | `600`             | URL Library desktop header/filter rendering shows minor cross-runner drift on GitHub macOS parity node (recent CI diff: `212`).                  | `<= 100`          |
| `urls-library-narrow.png`           | `600`             | URL Library narrow filter/header rendering shows minor cross-runner drift on GitHub macOS parity node (recent CI diff: `206`).                   | `<= 100`          |
