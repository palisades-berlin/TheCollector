...
**Status:** Design direction — Figma-first (ADR 0016), implement after DS 2.0 Sprint 1
...
_All changes go to Figma first (ADR 0016; per `docs/ui-handoff.md` change policy). Token updates are applied in `src/shared/ui.css` only — surface layers consume them automatically via aliases._
