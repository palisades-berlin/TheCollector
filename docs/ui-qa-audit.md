...
- Source of truth: Figma `THECollector - UI Kit & Screens` (ADR 0016; ADR 0015 retained as historical period)
...
> Historical note: this section captures a prior sync checkpoint. Active authority is Figma under ADR 0016.
