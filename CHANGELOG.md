...
- `docs/design-overhaul-master-plan-2026-03-13.md`: added Phase 0 status columns to all task tables (✅/⬜); fixed Status field typo ("replaces Penpot" → "replaces Figma"); updated `_Last updated` line.
- `docs/ui-handoff.md`: replaced stale "page index to be updated" note; split Penpot Page Index into "DS 2.0 Active Pages" table (with phase status) and "Figma Import Baseline" reference table.
- `docs/thecollector-2.0-90-day-roadmap.md`: added DS 2.0 Phase 0-A/B/C progress to Persisted Roadmap Progress Baseline (items 12–15); updated versioning status to note docs-only bumps and Phase 1 gate conditions.
- `SESSION.md`: added pending 0-C-6–8 and 0-A pending items to Open decisions section.
