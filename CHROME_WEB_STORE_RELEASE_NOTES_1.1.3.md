...
- New unified popup with two tabs:
  - `Capture`: full-page screenshot capture
  - `URLs`: clean URL collection and export tools
- URL collection supports:
  - Add current tab
...
- No cloud sync or server upload was introduced; data remains local.
